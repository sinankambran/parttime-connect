...
const RecruiterEditJob = () => {
  ...
  console.log(`this is comming from useSelector store.job${singleJob}`);
    ...
    <div>
      ...
      <div className="flex items-center justify-center w-screen my-10">
        ...
        >
          ...
          {loading ? (
            <Button className="w-full my-4 bg-[#3575e2]">
              {" "}
              <Loader2 className="mr-2 h-4 w-4 animate-spin" /> Please wait{" "}
            </Button>
          ) : (
            <Button type="submit" className="w-full my-4 bg-[#3575e2]">
              Update
            </Button>
          )}
          {/* {companies.length === 0 && (
