...
import { Input } from '@/components/ui/input'
import React, { useContext, useEffect, useState } from 'react'
// Uncomment this import to use Rating component
import { Rating } from '@smastrom/react-rating'
import '@smastrom/react-rating/style.css' // Ensure the CSS is also imported
...
function Skills() {
    ...
    useEffect(() => {
        // Check if resumeInfo exists and has skills data
