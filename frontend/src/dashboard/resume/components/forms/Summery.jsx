...
const promptTemplate = "Job Title: {jobTitle}, Based on the job title, provide a list of summary options for two experience levels: Mid Level and Fresher. Format in JSON array with 'summary' and 'experience_level'.";
...
function Summery({ enabledNext }) {
  ...
  const generateSummeryFromAI = async () => {
    try {
      setLoading(true);
      const PROMPT = promptTemplate.replace('{jobTitle}', resumeInfo?.jobTitle || 'N/A');
